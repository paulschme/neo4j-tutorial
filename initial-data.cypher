...
CREATE (player2_ger)-[:TEAMMATE]->(player1_ger)
...
CREATE (player3_ger)-[:TEAMMATE]->(player1_ger)
CREATE (player3_ger)-[:TEAMMATE]->(player2_ger)
...
CREATE (player4_ger)-[:TEAMMATE]->(player1_ger)
CREATE (player4_ger)-[:TEAMMATE]->(player2_ger)
CREATE (player4_ger)-[:TEAMMATE]->(player3_ger)
...
CREATE (player5_ger)-[:TEAMMATE]->(player1_ger)
CREATE (player5_ger)-[:TEAMMATE]->(player2_ger)
CREATE (player5_ger)-[:TEAMMATE]->(player3_ger)
CREATE (player5_ger)-[:TEAMMATE]->(player4_ger)
CREATE (player5_ger)-[:TEAMMATE]->(player6_ger)
CREATE (player5_ger)-[:TEAMMATE]->(player7_ger)
CREATE (player5_ger)-[:TEAMMATE]->(player8_ger)

CREATE (player6_ger)-[:TEAMMATE]->(player1_ger)
CREATE (player6_ger)-[:TEAMMATE]->(player2_ger)
CREATE (player6_ger)-[:TEAMMATE]->(player3_ger)
CREATE (player6_ger)-[:TEAMMATE]->(player4_ger)
CREATE (player6_ger)-[:TEAMMATE]->(player5_ger)
CREATE (player6_ger)-[:TEAMMATE]->(player7_ger)
CREATE (player6_ger)-[:TEAMMATE]->(player8_ger)

CREATE (player7_ger)-[:TEAMMATE]->(player1_ger)
CREATE (player7_ger)-[:TEAMMATE]->(player2_ger)
CREATE (player7_ger)-[:TEAMMATE]->(player3_ger)
CREATE (player7_ger)-[:TEAMMATE]->(player4_ger)
CREATE (player7_ger)-[:TEAMMATE]->(player5_ger)
CREATE (player7_ger)-[:TEAMMATE]->(player6_ger)
CREATE (player7_ger)-[:TEAMMATE]->(player8_ger)

CREATE (player8_ger)-[:TEAMMATE]->(player1_ger)
CREATE (player8_ger)-[:TEAMMATE]->(player2_ger)
CREATE (player8_ger)-[:TEAMMATE]->(player3_ger)
CREATE (player8_ger)-[:TEAMMATE]->(player4_ger)
CREATE (player8_ger)-[:TEAMMATE]->(player5_ger)
CREATE (player8_ger)-[:TEAMMATE]->(player6_ger)
CREATE (player8_ger)-[:TEAMMATE]->(player7_ger)
